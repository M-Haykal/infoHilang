        ...
        <form action="{{ route('login') }}" method="POST" class="space-y-5">
            ...
            <div class="space-y-1">
                ...
                <div class="relative">
                    ...
                    <input type="email" id="email" name="email" required value="{{ old('email') }}" class="w-full pl-10 pr-4 py-3 border border-netral-200 rounded-xl focus:border-primary bg-netral-50 text-sm transition-all outline-none" placeholder="nama@email.com" />
                </div>
                @error('email')
