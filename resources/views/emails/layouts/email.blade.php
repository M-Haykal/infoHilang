        ...
        <section style="max-width: 42rem; background-color: #fff;">
            ...
            <main style="text-align : start; padding-left : 20px; padding-right : 20px;">
                ...
                <p style="margin-top : 10px;">
                    You’re joining an amazing community of <span style="font-weight : bold; ">TailwindCSS</span>. You'll
                    be the first to hear about updates on new components, templates, and much more. If you’re interested
                    in learning more about TailwindCSS or need help creating your site in Tailwind, feel free to contact
                    our developer team at any time. We’re always here to help you in any way we can.
                </p>
            ...
            <p style="padding-left: 1.25rem; padding-right: 1.25rem; margin-top: 2rem;">
                This email was sent from <a href="mailto:sales@infynno.com" alt="sales@infynno.com"
                    target="_blank">sales@infynno.com</a>. If you'd rather not receive this kind of email, you can <a
                    href="#">unsubscribe</a> or <a href="#">manage your email preferences</a>.
            </p>
