<div class="py-20 max-w-7xl mx-auto px-4">
    ...
    <div class="text-center mb-10">
            <h2 class="text-3xl md:text-4xl font-extrabold text-slate-800">Daftar Hilang &amp; Ditemukan</h2>
    ...
    <div class="px-4 py-3">
        <label class="flex flex-col min-w-40 h-14 w-full">
            <div class="flex w-full flex-1 items-stretch rounded-xl h-full shadow-sm bg-white dark:bg-secondary">
                ...
                <input wire:model.live.debounce.500ms="search" class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-text-primary dark:text-gray-200 focus:outline-0 focus:ring-2 focus:ring-primary/50 border-none bg-transparent h-full placeholder:text-text-secondary px-4 pl-2 text-base font-normal leading-normal dark:placeholder:text-gray-500" placeholder="Cari barang, hewan, atau orang..." type="text" />
            </div>
        </label>
    </div>
    ...
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <aside class="w-full lg:w-1/4 xl:w-1/5 p-4">
            <div class="sticky top-24 bg-white dark:bg-secondary-800 rounded-xl shadow-md p-5 border border-gray-200 dark:border-gray-700">
        ...
        <div class="w-full lg:w-3/4 xl:w-4/5">
            <div class="flex items-center justify-between p-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button class="p-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300">
            ...
            <div class="grid grid-cols-1 gap-6 p-4 sm:grid-cols-2 xl:grid-cols-3">
                ...
                <div class="flex flex-col overflow-hidden rounded-xl border bg-white shadow-md transition-all hover:-translate-y-1">
                    <div class="relative">
                        <img class="aspect-square w-full object-cover" src="{{ asset($report->foto[0] ?? 'default.jpg') }}" alt="{{ $report->report_name }}" />
                    ...
                    <div class="flex flex-1 flex-col p-4 bg-secondary/90">
                        ...
                        <div class="mt-1 mb-4 flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                            <i class="fa-solid fa-calendar"></i>
                            <span>{{ $report->created_at->diffForHumans() }}</span>
                        </div>
                        <a href="" class="w-full flex items-center justify-center bg-slate-800 hover:bg-slate-900 text-white font-bold text-sm py-2 rounded-lg transition">
                            Detail Laporan
                        </a>
                    </div>
                </div>
