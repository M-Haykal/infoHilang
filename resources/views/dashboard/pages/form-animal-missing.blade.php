        ...
        @if (session('success'))
            <div class="max-w-5xl mx-auto">
                <div id="toast-success"
                    class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 duration-300 ease-in-out mx-auto"
                    role="alert">
                    <div
                        class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-success/500 bg-success/100 rounded-lg">
